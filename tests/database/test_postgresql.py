...
class TestPostgresFunctions(TestCase):
    ...
    def test_postgres_create_database_if_not_exists(self, mock_create_engine):
        ...
        with patch.object(Base.metadata, 'create_all', side_effect=[OperationalError("fail", None, None), None]) as mock_create_all:
            mock_conn = MagicMock()
    ...
    def test_postgres_create_database_create_fail(self, mock_create_engine):
        ...
        with patch.object(Base.metadata, 'create_all', side_effect=OperationalError("fail", None, None)):
