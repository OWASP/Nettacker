...
PORT_TELNET = 23
USERNAME = "admin"
PASSWORD = "secret"  # noqa: S105 - test credential
INVALID_SECRET = "wrong"  # noqa: S105 - negative test credential
TIMEOUT = 5
...
class TestSshLibrary:
    ...
    def test_brute_force_auth_failure(self, mock_ssh_cls):
        ...
        with pytest.raises(AuthenticationException):
            lib.brute_force(host=HOST, port=PORT_SSH, username=USERNAME, password=INVALID_SECRET)
