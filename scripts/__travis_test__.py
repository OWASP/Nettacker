...
if (
    os.system(
        "time python nettacker.py -i 127.0.0.1 -u user1,user2 -p "
...
if (
    os.system(
        ...
        ' --method-args "subdomain_scan_time_limit_seconds=5" -v 5 '
    )
    is not 0
):
    sys.exit(1)
...
if (
    os.system(
        ...
        '-v 5 --method-args "subdomain_scan_time_limit_seconds=5"'
    )
    is not 0
):
    sys.exit(1)
...
os.system(
    "time python nettacker.py -i 127.0.0.1 -u user1,user2 -p pass1,pass2 -m all -g 21,25,80,443 -t 10000000"
