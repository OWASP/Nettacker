    ...
    return \
        {
            ...
            "shodan_results_found": "Found Shodan results: {0}",
            "shodan_results_not_found": "Didn't find anything in the Shodan database",
            ...
            "graphql_inspection_console": "Found GraphQL Console having Introspection Queries Enabled!",
            "no_vulnerability_found": "no vulnerability found! ({0})",
            "console_not_found": "GraphQL console not found!",
            "Method": "Method",
            "API": "API",
            ...
            "using_shodan_query_override": "Using {0} as a target for Shodan",
