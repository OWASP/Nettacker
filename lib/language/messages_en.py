    ...
    return \
        {
            ...
            "184": "http basic authentication success - host:{2}, user: {0}, pass:{1} found!",
            "185": "http basic authentication failed to {0} using {1}:{2}",
            "186": "http form authentication success - host:{2}, user: {0}, pass:{1} found!",
            "187": "http form authentication failed to {0} using {1}:{2}",
        }
