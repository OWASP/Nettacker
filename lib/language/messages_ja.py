    ...
    return \
		{
			...
			"35": "メソッドの入力を入力します（例： \"ftp_brute_users = test、admin＆ftp_brute_passwds = read_from_file：/tmp/pass.txt&ftp_brute_port=21\"",
			...
			"49": "重複するターゲットをスキップします（一部のサブドメイン/ドメインには同じIPと範囲が含まれることがあります）",
			"50": "不明なタイプのターゲット[{0}]",
			"51": "{0}の範囲をチェックしています...",
			"52": "{0}をチェックしています...",
			"53": "ホスト",
			...
			"69": "{0}モジュールの入力ターゲットはDOMAIN、HTTP、またはSINGLE_IPv4で、{1}をスキップする必要があります",
			...
			"85": "この機能はまだ利用できません。最後のバージョンを取得するには、 \"git clone https://github.com/viraintel/OWASP-Nettacker.git\"または \"pip install -U OWASP-Nettacker\"を実行してください。",
			"86": "すべての活動と情報のグラフを作成するには、HTML出力を使用する必要があります。利用可能なグラフ：{0}",
			"87": "グラフフィーチャを使用するには、出力ファイル名が \".html\"または \".htm\"で終わる必要があります。",
			"88": "グラフを作成する...",
			"89": "グラフを完成させる！",
			"90": "侵入テストグラフ",
			"91": "このグラフは、OWASP Nettackerによって作成されました。グラフには、すべてのモジュールアクティビティ、ネットワークマップ、機密情報が含まれています。信頼できない場合は、このファイルを誰とも共有しないでください。",
