    ...
    return \
        {
            ...
            "license": "Խնդրում ենք կարդալ լիցենզիա եւ համաձայնագրեր https://github.com/viraintel/OWASP-Nettacker",
            "engine": "Շարժիչ",
            ...
            "feature_unavailable": "այս հատկությունը հասանելի չէ: խնդրում ենք վազել \"git clone "
                                   "https://github.com/viraintel/OWASP-Nettacker.git կամ pip install "
