    ...
    return \
        {
            ...
            "35": "ورودی های متود ها را وارد کنید، مثال: \"ftp_brute_users=test,admin&ftp_brute_passwds=read_from_file:/tmp/pass.txt&ftp_brute_port=21\"",
            ...
            "62": "پراکسی ارتباطات خروجی (socks) مثال: 127.0.0.1:9050، socks://127.0.0.1:9050، socks5:127.0.0.1:9050 یا socks4: socks4://127.0.0.1:9050, احراز هویت: socks://username:password@127.0.0.1, socks4://username:password@127.0.0.1, socks5://username:password@127.0.0.1",
            "63": "لطفا آدرس و پورت معتبر socks را وارد کنید. socks5 مثال: 127.0.0.1:9050، socks://127.0.0.1:9050، socks5:127.0.0.1:9050 یا socks4: socks4://127.0.0.1:9050, احراز هویت: socks://username:password@127.0.0.1, socks4://username:password@127.0.0.1, socks5://username:password@127.0.0.1",
            ...
            "68": "ارتباط ftp به {0}:{1} نا موفق بود، از کل مرحله [روند {2} از {3}] چشم پوشی شد! در حال رفتن به مرحله بعد",
            ...
            "72": "تلاش برای {0} از {1} در روند {2} از {3} {4}:{5}",
            "73": "ارتباط smtp به {0}:{1} قطع شد، جشم پوشی از {2}:{3}",
            "74": "ارتباط smtp به {0}:{1} ناموفق بود، از کل مرحله [روند {2} از {3}]! چشم پوشی شد! در حال رفتن به مرحله بعد",
            "75": "ورودی هدف برای ماژول {0} باید از نوع HTTP باشد، از {1} چشم پوشی",
            "76": "ارتباط ssh به {0}:{1} قطع شد، چشم پوشی از {2}:{3}",
            "77": "ارتباط ssh به {0}:{1} ناموفق بود، از کل مرحله [روند {2} از {3}]! چشم پوشی شد! در حال رفتن به مرحله بعد",
            ...
            "85": "این ویژگی هنوز فعال نشده است! لطفا \"git clone https://github.com/viraintel/OWASP-Nettacker.git\" یا \"pip install -U OWASP-Nettacker\" را جهت گرفتن اخرین ورژن اجرا کنید.",
            ...
            "89": "پایان ساخت گراف!",
            "90": "گراف تست نفوذ",
            "91": "این گراف توسط OWASP Nettacker ایجاد شده است. گراف شامل فعالیت همه ماژول ها، نقشه شبکه و اطلاعات حساس می باشد، لطفا با کسی که قابل اعتماد نیست به اشتراک تگذارید.",
