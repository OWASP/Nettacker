    ...
    return \
        {
            ...
            "license": "Si prega di leggere la licenza e gli accordi https://github.com/viraintel/OWASP-Nettacker",
            "engine": "Motore",
            ...
            "feature_unavailable": "questa funzione non è ancora disponibile! per favore lancia \"git clone "
                                   "https://github.com/viraintel/OWASP-Nettacker.git o pip install -U OWASP-Nettacker "
