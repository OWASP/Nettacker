    ...
    return \
        {
            ...
            "29": "ορίστε το χρονικό όριο στα {0} δευτερόλεπτα, είναι πολύ μεγάλο, έτσι δεν είναι;"
                  " από τον τρόπο που συνεχίζουμε ...",
            ...
            "35": "εισάγετε τις μεθόδους εισόδου, για παράδειγμα: \"ftp_brute_users=test,"
                  "admin&ftp_brute_passwds=read_from_file:/tmp/pass.txt&ftp_brute_port=21\"",
            "36": "δεν μπορεί να διαβάσει το αρχείο {0}",
            "37": "Δεν είναι δυνατός ο προσδιορισμός των ονομάτων χρηστών που δεν"
            ...
            "68": "Η σύνδεση ftp με {0}: {1} απέτυχε, παραλείποντας ολόκληρο το βήμα [διαδικασία {2} "
                  "της {3}]! πηγαίνετε στο επόμενο βήμα",
            "69": "ο στόχος εισόδου για τη λειτουργική μονάδα {0} πρέπει να είναι DOMAIN, HTTP ή "
                  "SINGLE_IPv4, παρακάμπτοντας {1}",
            ...
            "74": "η σύνδεση smtp με {0}: {1} απέτυχε, παρακάμπτοντας ολόκληρο το βήμα [process {2} of "
                  "{3}]! πηγαίνετε στο επόμενο βήμα",
            ...
            "77": "Η σύνδεση ssh με {0}: {1} απέτυχε, παραλείποντας ολόκληρο το βήμα [διαδικασία {2} της"
                  " {3}]! πηγαίνετε στο επόμενο βήμα",
            "78": "Η σύνδεση ssh με% s:% s απέτυχε, παραλείποντας ολόκληρο το βήμα [διαδικασία% s του% s]!"
            ...
            "85": "αυτή η λειτουργία δεν είναι ακόμα διαθέσιμη! εκτελέστε το \"git clone https://github.com/"
                  "viraintel/OWASP-Nettacker.git\" ή \"pip install -U OWASP-Nettacker\" για να λάβετε"
                  " την τελευταία έκδοση.",
            "86": "να δημιουργήσετε ένα γράφημα όλων των δραστηριοτήτων και πληροφοριών, πρέπει να χρησιμοποιήσετε "
                  "την έξοδο HTML. διαθέσιμα γραφήματα: {0}",
            "87": "για να χρησιμοποιήσετε τη γραφική παράσταση, το όνομα αρχείου εξόδου πρέπει να τελειώνε"
                  "ι με \".html\" ή \".htm\"!",
            "88": "γραφικό κτίριο ...",
            "89": "φινίρισμα γραφικών!",
            "90": "Γραφήματα δοκιμής διείσδυσης",
            "91": "Αυτό το γράφημα δημιουργήθηκε από το OWASP Nettacker. Το "
                  "γράφημα περιέχει όλες τις δραστηριότητες ενότητες, τον χάρτη δικτύου και τις ευαίσθητες πληροφορίες."
                  " Μην μοιραστείτε αυτό το αρχείο με οποιονδήποτε, αν δεν είναι αξιόπιστο.",
            ...
            "100": "παρακάμπτοντας ολόκληρο τον στόχο {0} και τη μέθοδο σάρωσης {1} εξαιτίας του "
                   "--ping-before-scan είναι αλήθεια και δεν απάντησε!",
