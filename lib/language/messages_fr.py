    ...
    return \
        {
            ...
            "29": "définissez le délai d'expiration sur {0} secondes, c'est trop gros, n'est-ce pas? par la façon dont nous continuons ...",
            ...
            "49": "Ignorer la cible dupliquée (certains sous-domaines / domaines peuvent avoir la même IP et les mêmes plages)",
            ...
            "68": "la connexion ftp à {0}: {1} a échoué, sauter toute l'étape [processus {2} de {3}]! passer à l'étape suivante",
            ...
            "74": "La connexion smtp à {0}: {1} a échoué, sautant toute l'étape [process {2} of {3}]! passer à l'étape suivante",
            "75": "la cible d'entrée pour le module {0} doit être HTTP, en ignorant {1}",
            "76": "connexion ssh à {0}: {1} timeout, en ignorant {2}: {3}",
            "77": "La connexion ssh à {0}: {1} a échoué, sauter toute l'étape [process {2} of {3}]! passer à l'étape suivante",
            "78": "connexion ssh à% s:% s a échoué, sauter toute l'étape [processus% s de% s]! passer à l'étape suivante",
            "79": "PORT OUVERT",
            ...
            "85": "cette fonctionnalité n'est pas encore disponible! veuillez exécuter \"git clone https://github.com/viraintel/OWASP-Nettacker.git\" ou \"pip installer -U OWASP-Nettacker\" pour obtenir la dernière version.",
            "86": "construire un graphique de toutes les activités et informations, vous devez utiliser la sortie HTML. graphiques disponibles: {0}",
            "87": "pour utiliser la fonction graphique, votre nom de fichier de sortie doit se terminer par \".html\" ou \".htm\"!",
            "88": "graphique de construction ...",
            "89": "terminer la construction graphique!",
            "90": "Graphiques de test de pénétration",
            "91": "Ce graphique a été créé par OWASP Nettacker. Le graphique contient toutes les activités des modules, la carte réseau et les informations sensibles. Veuillez ne partager ce fichier avec personne si ce n'est pas fiable.",
            ...
            "100": "en sautant la cible entière {0} et la méthode d'analyse {1} à cause de --ping-before-scan est vrai et n'a pas répondu!",
