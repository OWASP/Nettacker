...
def extra_requirements_dict():
    return {"xmlrpc_bruteforce_vuln_ports": [80, 443]}
    ...
    if xmlrpc_bruteforce(
        ...
        info(
            messages(language, "target_vulnerable").format(
                target, port, "Wordpress_xmlrpc_bruteforce"
            )
        )
