    ...
    if options_method(
        ...
        info(
            messages(language, "target_vulnerable").format(
                target, port, "Options Method enabled (Methods Available) - " + header
            )
        )
        ...
        data = json.dumps(
            {
                ...
                "PASSWORD": "",
                "PORT": port,
                "TYPE": "options_method_enabled_vuln",
