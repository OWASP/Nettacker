...
def extra_requirements_dict():
    return {"bftpd_vuln_ports": [21, 990]}
        ...
        data = json.dumps(
            {
                ...
                "PASSWORD": "",
                "PORT": port,
                "TYPE": "Bftpd_parsecmd_overflow_vuln",
