    ...
    while 1:
        ...
        try:
            ...
            if status_code != 200:
                ...
                if exit is retries:
                    warn(
                        messages(language, "http_ntlm_failed").format(
                ...
                if flag is 0:
                    info(
                        messages(language, "http_ntlm_success").format(
...
def start(
    ...
    if (
        ...
        warn(messages(language, "input_target_error").format("http_ntlm_brute", target))
