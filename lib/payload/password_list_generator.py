...
# Password List Generator tool https://github.com/pradeepjairamani/password_list_generator
...
def generate(filename):
    ...
    leet = input("[+] 1337 mode? (Example:  hello = h3110 ) : [y/n] ").lower() #1337 mode can convert the characters to leet speak and hello = h3110 
    ...
    list1=[fname,lname,nick,emails,funame,nuick,phone,partner,partnick,bestf,purtname,purtnick,bustf,child,company,chld,cumpny]
    for i in words2:
        list1.append(i)
