...
def extra_requirements_dict():
    return {"drupal_version_ports": [80, 443]}
...
def __drupal_version(
    ...
    if version:
        info(messages(language, "found").format(target, "drupal Version", version))
