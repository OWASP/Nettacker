...
def extra_requirements_dict():
    return {"drupal_modules_ports": [80, 443]}
...
def __drupal_modules(
    ...
    if modules:
        info(messages(language, "found").format(target, "drupal modules", modules))
