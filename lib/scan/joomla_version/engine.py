...
def extra_requirements_dict():
    return {"joomla_version_ports": [80, 443]}
    ...
    try:
        ...
        if not s:
            ...
            if req.status_code == 404:
                req = requests.get(target + "/administrator/manifests/files/joomla.xml")
            try:
                global version
...
def __joomla_version(
    ...
    if joomla_version(
        ...
        info(messages(language, "found").format(target, "Joomla Version", version))
