...
def extra_requirements_dict():
    return {
        ...
        "pma_scan_list": ['/admin/', '/accounts/login/', '/admin1.php/', '/admin.php/',
                          ...
                          '/phpMyAdmin-2.6.0-alpha/', '/phpMyAdmin-2.6.0-alpha2/', '/phpMyAdmin-2.6.0-beta1/',
                          '/phpMyAdmin-2.6.0-beta2/', '/phpMyAdmin-2.6.0-rc1/', '/phpMyAdmin-2.6.0-rc2/',
                          ...
                          '/phpMyAdmin-2.6.2-rc1/', '/phpMyAdmin-2.6.2-beta1/', '/phpMyAdmin-2.6.2-rc1/',
                          ...
                          '/phpMyAdmin-2.7.0-beta1/', '/phpMyAdmin-2.7.0-rc1/', '/phpMyAdmin-2.7.0-pl1/',
                          '/phpMyAdmin-2.7.0-pl2/', '/phpMyAdmin-2.7.0/', '/phpMyAdmin-2.8.0-beta1/',
                          ...
                          '/PMA2005/', '/pma2005/', '/phpmanager/', '/php-myadmin/', '/phpmy-admin/', '/webadmin/',
                          '/sqlweb/', '/websql/', '/webdb/', '/mysqladmin/', '/mysql-admin/', '/mya/', '/mysql/admin/',
                          '/mysql/dbadmin/', '/mysql/sqlmanager/', '/mysql/mysqlmanager/', '/phpMyadmin/', '/phpmyAdmin/',
                          '/phpmyadmin3/', '/phpmyadmin4/', '/2phpmyadmin/', '/phpmy/', '/phppma/', '/db/phpmyadmin/',
                          '/db/phpMyAdmin/', '/admin/phpmyadmin/', '/admin/phpMyAdmin/', '/admin/sysadmin/',
                          '/admin/sqladmin/', '/admin/db/', '/admin/web/', '/admin/pMA/', '/mysql/pma/', '/mysql/pMA/',
                          '/sql/phpmanager/', '/sql/php-myadmin/', '/sql/phpmy-admin/', '/sql/myadmin/', '/sql/webadmin/',
                          '/sql/sqlweb/', '/sql/websql/', '/sql/webdb/', '/sql/sqladmin/', '/sql/sql-admin/',
                          '/sql/phpmyadmin2/', '/sql/phpMyAdmin2/', '/sql/phpMyAdmin/', '/db/myadmin/', '/db/webadmin/',
                          '/db/websql/', '/db/dbadmin/', '/db/db-admin/', '/db/phpmyadmin3/', '/db/phpMyAdmin3/',
                          '/db/phpMyAdmin-3/', '/administrator/phpmyadmin/', '/administrator/phpMyAdmin/',
                          '/administrator/pma/', '/administrator/PMA/', '/phpMyAdmin3/', '/phpMyAdmin4/', '/phpMyAdmin-3/',
                          '/PMA2011/', '/PMA2012/', '/PMA2013/', '/PMA2014/', '/PMA2015/', '/PMA2016/', '/PMA2017/',
