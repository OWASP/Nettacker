...
def extra_requirements_dict():
    return {"wordpress_version_ports": [80, 443]}
...
def __wordpress_version(
    ...
    if wordpress_version(
        ...
        info(
            messages(language, "found").format(target, "Wordpress Version", version),
            log_in_file,
            "a",
            {
                "HOST": target,
