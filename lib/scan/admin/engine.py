...
def extra_requirements_dict():
    return {
        ...
        "admin_scan_list": [
            ...
            "administracion/login.php /panelc/",
            "/paneldecontrol/",
            "/panel.php",
            "/pgadmin/",
            "/phpldapadmin/",
            ...
            "/sub",
            "login/ /Super",
            "Admin/ /support_login/ /sys",
            "admin/ /sysadmin/ /SysAdmin/ /SysAdmin2/ /sysadmin.asp",
            "/sysadmin.html /sysadmin.php",
            "/sysadmins/",
            "/system_administration/",
            "/system",
            "administration/ /typo3/ /ur",
            "admin/ /ur",
            "admin.asp /ur",
            "admin.html /ur",
            "admin.php /useradmin/ /user.asp ",
            "/user.html",
            "/UserLogin/ /user.php",
            "/usuario/ /usuarios/ /usuarios// /usuarios/login.php",
            "/utility_login/",
            "/vadmind/",
            "/vmailadmin/",
            "/webadmin/ /WebAdmin/ /webadmin/admin.asp",
            "/webadmin/admin.html",
            "/webadmin/admin.php",
            "/webadmin.asp",
            "/webadmin.html",
...
def check(
    ...
    try:
        ...
        if r.status_code in status_codes:
            ...
            info(
                messages(language, "found").format(target, r.status_code, r.reason),
                log_in_file,
                "a",
                {
            ...
            if r.status_code is 200:
                for dlmsg in directory_listing_msgs:
                    if dlmsg in content:
                        info(
                            messages(language, "directory_listing").format(target),
                            log_in_file,
                            "a",
                            {
                                "HOST": target_to_host(target),
    ...
    if (
        ...
        if thread_write is 1:
            if verbose_level is not 0:
                info(
                    messages(language, "directory_file_404").format(
                        target, "default_port"
                    ),
                    log_in_file,
                    "a",
                    {
                        ...
                        "PORT": "",
                        "TYPE": "admin_scan",
                        "DESCRIPTION": messages(language, "direcroty_file_404").format(
                            target, "default_port"
                        ),
                        "TIME": now(),
                        "CATEGORY": "scan",
