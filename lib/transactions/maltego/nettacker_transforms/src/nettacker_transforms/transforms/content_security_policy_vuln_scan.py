...
from lib.vuln.content_security_policy.engine import start
...
@EnableDebugWindow
class ContentSecurityPolicyVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Content Security Policy Vulnerability Found!",
                link_label="content_security_policy_vuln",
            )
        return response
