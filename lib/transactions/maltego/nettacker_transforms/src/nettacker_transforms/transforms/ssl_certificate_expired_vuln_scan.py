...
from lib.vuln.ssl_certificate_expired.engine import start
...
@EnableDebugWindow
class SSLExpiredVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="SSL Certificate Expired!",
                link_label="ssl_certificate_expired_vuln",
            )
        return response
