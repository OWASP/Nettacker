...
from lib.vuln.ProFTPd_cpu_consumption.engine import start
...
@EnableDebugWindow
class ProFTPdCpuConsumptionVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd cpu consumption Found!",
                link_label="ProFTPd_cpu_consumption",
            )
        return response
