...
from lib.vuln.Bftpd_memory_leak.engine import start
...
@EnableDebugWindow
class BFTPDMemoryLeakVulnerablility(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Bftpd memory leak Vulnerability Found!",
                link_label="Bftpd_memory_leak_vuln",
            )
        return response
