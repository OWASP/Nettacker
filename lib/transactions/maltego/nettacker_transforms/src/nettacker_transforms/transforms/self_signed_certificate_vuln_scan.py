...
from lib.vuln.self_signed_certificate.engine import start
...
@EnableDebugWindow
class SelfSignedCertificateVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Self Signed Certificate Found!",
                link_label="self_signed_certificate_vuln",
            )
        return response
