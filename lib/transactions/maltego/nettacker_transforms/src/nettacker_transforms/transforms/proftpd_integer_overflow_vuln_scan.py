...
from lib.vuln.ProFTPd_integer_overflow.engine import start
...
@EnableDebugWindow
class ProFTPdIntegerOverflowVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd integer overflow Vulnerability Found!",
                link_label="ProFTPd_integer_overflow_vuln",
            )
        return response
