...
from lib.vuln.apache_struts.engine import start
...
@EnableDebugWindow
class ApacheStrutsVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Apache Struts Vulnerability Found!",
                link_label="apache_struts_vuln",
            )
        return response
