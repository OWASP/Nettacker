...
from lib.vuln.ProFTPd_heap_overflow.engine import start
...
@EnableDebugWindow
class ProFTPdHeapOverflowVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd heap overflow Vulnerability Found!",
                link_label="ProFTPd_heap_overflow_vuln",
            )
        return response
