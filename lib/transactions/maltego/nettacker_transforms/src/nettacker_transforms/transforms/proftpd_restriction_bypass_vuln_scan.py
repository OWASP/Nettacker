...
from lib.vuln.ProFTPd_restriction_bypass.engine import start
...
@EnableDebugWindow
class ProFTPdRestrictionBypassVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd restriction bypass Vulnerability Found!",
                link_label="ProFTPd_restriction_bypass_vuln",
            )
        return response
