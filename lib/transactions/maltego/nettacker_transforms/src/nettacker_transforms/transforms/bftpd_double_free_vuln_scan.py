...
from lib.vuln.Bftpd_double_free.engine import start
...
@EnableDebugWindow
class BFTPDDoubleFreeVulnerablility(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Bftpd double free Vulnerability Found!",
                link_label="Bftpd_double_free_vuln",
            )
        return response
