...
from lib.vuln.x_powered_by.engine import start
...
@EnableDebugWindow
class XPoweredByVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="X-Powered by vulnerability Found!",
                link_label="x_powered_by_vuln",
            )
        return response
