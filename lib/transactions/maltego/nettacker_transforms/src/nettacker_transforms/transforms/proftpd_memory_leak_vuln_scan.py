...
from lib.vuln.ProFTPd_memory_leak.engine import start
...
@EnableDebugWindow
class ProFTPdMemoryLeakVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd memory leak Vulnerability Found!",
                link_label="ProFTPd_memory_leak_vuln",
            )
        return response
