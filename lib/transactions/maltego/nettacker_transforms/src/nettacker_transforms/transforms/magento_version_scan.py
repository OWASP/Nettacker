...
@EnableDebugWindow
class MagentoVersionScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(url=url, title=result["DESCRIPTION"], short_title="magento Version"+version+" Found!",
                            link_label='magento_version_scan')
        return response
