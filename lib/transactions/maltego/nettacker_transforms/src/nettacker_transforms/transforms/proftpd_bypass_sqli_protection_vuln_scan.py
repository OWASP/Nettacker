...
from lib.vuln.ProFTPd_bypass_sqli_protection.engine import start
...
@EnableDebugWindow
class ProFTPdBypassSqliProtectionVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd bypass with SQLi Vulnerability Found!",
                link_label="ProFTPd_bypass_sqli_protection_vuln",
            )
        return response
