...
from lib.vuln.ProFTPd_directory_traversal.engine import start
...
@EnableDebugWindow
class ProFTPdDirectoryTraversalVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="ProFTPd directory traversal Found!",
                link_label="ProFTPd_directory_traversal_vuln",
            )
        return response
