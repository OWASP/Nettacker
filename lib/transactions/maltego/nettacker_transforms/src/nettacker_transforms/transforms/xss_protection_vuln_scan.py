...
from lib.vuln.XSS_protection.engine import start
...
@EnableDebugWindow
class XSSProtectionVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="XSS protection Vulnerability Found!",
                link_label="XSS_protection_vuln",
            )
        return response
