...
from lib.vuln.options_method_enabled.engine import start
...
@EnableDebugWindow
class OptionsMethodEnabledSVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Options Method Enabled!",
                link_label="options_method_enabled_vuln",
            )
        return response
