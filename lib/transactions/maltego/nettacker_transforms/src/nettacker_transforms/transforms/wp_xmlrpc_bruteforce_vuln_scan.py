...
from lib.vuln.wp_xmlrpc_bruteforce.engine import start
...
@EnableDebugWindow
class WordpressXMLPRCBruteforceVulnScan(Transform):
    ...
    def do_transform(self, request, response, config):
        ...
        for result in results:
            ...
            response += URL(
                ...
                short_title="Wordpress XMLPRC Bruteforce vulnerability Found!",
                link_label="wp_xmlrpc_bruteforce_vuln",
            )
        return response
